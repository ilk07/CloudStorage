...
class ExceptionHandlerAdviceTest {
    ...
    void badCredentialsExceptionHandler_shouldReturnResponse400_WithErrorTypeId101() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(result -> result.getResponse().getContentAsString().contains("id"))
                .andExpect(result -> result.getResponse().getContentAsString().contains("message"))
                .andExpect(result -> result.getResponse().getContentAsString().contains("103"));
    }
